...
export function AppSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
  ...
  const data = {
    ...
    navMain: [
      ...
      },
      {
        ...
        isActive: pathname === "/campaigns" || pathname === "/templates",
        items: [
          {
            title: "All campaigns",
            url: "/campaigns",
      ...
      },
      {
        ...
        items: [
          { title: "Overview", url: "/automations" },
          { title: "All journeys", url: "/automations/journeys" },
          { title: "Pre-built journeys", url: "/automations/pre-built" },
          { title: "Transactional email", url: "/automations/transactional" },
        ],
      ...
      },
      {
        ...
        items: [
          { title: "All contacts", url: "/audience/lists" },
          { title: "Audience dashboard", url: "/audience/dashboard" },
          { title: "Signup forms", url: "/forms" },
          { title: "Tags", url: "/audience/tags" },
        ],
        isActive: pathname.startsWith("/audience") || pathname === "/forms",
      },
      {
        title: "Analytics",
        url: "/analytics",
        ...
        items: [
          ...
          { title: "Click Heatmaps", url: "/analytics/heatmap" },
          { title: "Audience Insights", url: "/analytics/audience" },
          { title: "Trend Analysis", url: "/analytics/trends" },
        ],
  ...
  return (
    <Sidebar
      collapsible="icon"
      {...props}
      className="!group-data-[side=left]:border-r-0 space-y-8"
    >
      <SidebarHeader>
